...
const snackbar = createSlice({
  ...
  reducers: {
    openSnackbar(state, action) {
      const { open, message, anchorOrigin, variant, alert, transition, close, actionButton, severity, hideIconVariant, autoHideDuration } = action.payload;
      ...
      state.autoHideDuration = autoHideDuration !== undefined ? autoHideDuration : initialState.autoHideDuration;
    },
